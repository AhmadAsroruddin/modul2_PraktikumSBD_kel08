...
$data->id_admin) }}" type="button" class="btn btn-
warning rounded-3">Ubah</a>
...
btn-danger" data-bs-toggle="modal" data-bs-
...
id="hapusModal{{ $data->id_admin }}" tabindex="-1"
...
<h5 class="modal-
title" id="hapusModalLabel">Konfirmasi</h5>
