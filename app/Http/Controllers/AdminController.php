...
class AdminController extends Controller
{
    public function create() {
        ...
        DB::insert('INSERT INTO admin(id_admin,
        ...
        public function edit($id) {
            ...
            DB::update('UPDATE admin SET id_admin =
            :id_admin, nama_admin = :nama_admin, alamat = :alamat,
            ...
            public function delete($id) {
                // Menggunakan Query Builder Laravel dan Name Bindings untuk valuesnya
                DB::delete('DELETE FROM admin WHERE id_admin =
